...
const arrJokes = jokes.filter(joke => joke.jokeType === type);
res.json(arrJokes)
...
app.patch("/jokes/:id",(req, res) => {
  ...
  const changedJoke = {
    id:id,
    jokeText: req.body.text || thisJoke.jokeText,
    jokeType: req.body.type || thisJoke.jokeType,
  }
  const searchIndex = jokes.findIndex((joke) => joke.id === id);
  jokes[searchIndex] = changedJoke;
  console.log(jokes[searchIndex]);
...
app.delete("/all", (req, res) => {
  ...
  if (userKey === masterKey){
    ...
    res
    .status(400)
    .json({error: `You are not authorised to delete all jokes!`});
  } 
})
